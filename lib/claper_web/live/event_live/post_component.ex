          ...
          <%= if @post.name || is_a_leader(@post, @event, @leaders) do %>
            <div class="inline-flex items-center">
              ...
              <%= if is_pinned(@post) do %>
                <div class="inline-flex items-center space-x-1 justify-center px-3 py-0.5 rounded-full text-xs font-medium bg-supporting-yellow-100 text-supporting-yellow-800 mb-2 ml-2">
