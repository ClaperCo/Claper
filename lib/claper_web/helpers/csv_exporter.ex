defmodule ClaperWeb.Helpers.CSVExporter do
  ...
  def export_users_to_csv(users) do
    headers = ["Email", "Role", "Date Created"]
    fields = [:email, :role, :inserted_at]
  ...
  def export_events_to_csv(events) do
    headers = ["Name", "Code", "Started At", "Expired At", "Audience Peak", "Date Created"]
    fields = [:name, :code, :started_at, :expired_at, :audience_peak, :inserted_at]
